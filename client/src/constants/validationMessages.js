export const VALIDATION_MESSAGES = {
	...
	PASSENGER: {
		...
		document_number: {
			...
			PASSPORT_RF: 'Номер паспорта РФ должен соответствовать формату: 1234567890',
			INTERNATIONAL_PASSPORT_RF: 'Номер загранпаспорта РФ должен соответствовать формату: 123456789',
			BIRTH_CERTIFICATE: 'Номер свидетельства о рождении должен соответствовать формату: 12АБ345678',
		},
	...
	AIRCRAFT: {
		...
		economy_seats: {
			REQUIRED: 'Количество мест эконом-класса обязательно',
			NON_NEGATIVE: 'Количество мест эконом-класса должно быть неотрицательным',
			INVALID: 'Введите корректное число мест эконом-класса',
		},
		business_seats: {
			REQUIRED: 'Количество мест бизнес-класса обязательно',
			NON_NEGATIVE: 'Количество мест бизнес-класса должно быть неотрицательным',
			INVALID: 'Введите корректное число мест бизнес-класса',
		},
	},
