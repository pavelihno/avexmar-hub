...
Revision ID: 7f5625189057
Revises: 
Create Date: 2025-07-14 16:02:32.935595
...
def upgrade():
    ...
    op.create_table('bookings',
                    ...
                    sa.Column('status', sa.Enum('created', 'pending_payment',
                              'confirmed', 'cancelled', name='booking_status'), nullable=False),
                    sa.Column('email_address', sa.String(), nullable=False),
                    sa.Column('phone_number', sa.String(), nullable=False),
                    sa.Column('first_name', sa.String(), nullable=False),
                    sa.Column('last_name', sa.String(), nullable=False),
                    sa.Column('currency', sa.Enum(
                        'rub', name='currency'), nullable=False),
    ...
    op.create_table('discounts',
                    ...
                    sa.Column('discount_type', sa.Enum(
                        'round_trip', 'infant', 'child', name='discount_type'), nullable=False),
    ...
    op.create_table('passengers',
                    sa.Column('first_name', sa.String(), nullable=False),
                    sa.Column('last_name', sa.String(), nullable=False),
                    sa.Column('document_type', sa.Enum('passport', 'foreign_passport',
                                                       'international_passport', 'birth_certificate', name='document_type'), nullable=False),
                    sa.Column('document_number', sa.String(), nullable=False),
                    sa.Column('birth_date', sa.Date(), nullable=False),
                    sa.Column('gender', sa.Enum(
                        'м', 'ж', name='gender'), nullable=False),
                    sa.Column('id', sa.Integer(),
                              autoincrement=True, nullable=False),
                    sa.Column('created_at', sa.DateTime(), nullable=False),
                    sa.Column('updated_at', sa.DateTime(), nullable=False),
                    ...
                    sa.UniqueConstraint('document_number', 'document_type',
                                        name='uix_document_number_type')
                    )
    op.create_table('users',
                    sa.Column('email', sa.String(), nullable=False),
                    sa.Column('password', sa.String(), nullable=False),
                    sa.Column('role', sa.Enum('admin', 'standard',
    ...
    op.create_table('payments',
                    ...
                    sa.Column('payment_method', sa.Enum(
                        'card', 'cash', name='payment_method'), nullable=False),
                    sa.Column('payment_status', sa.Enum('pending', 'paid',
                                                        'refunded', 'failed', name='payment_status'), nullable=False),
                    sa.Column('id', sa.Integer(),
                              autoincrement=True, nullable=False),
                    sa.Column('created_at', sa.DateTime(), nullable=False),
                    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_table('routes',
                    sa.Column('origin_airport_id',
                              sa.Integer(), nullable=False),
                    sa.Column('destination_airport_id',
                              sa.Integer(), nullable=False),
                    sa.Column('id', sa.Integer(),
                              autoincrement=True, nullable=False),
                    sa.Column('created_at', sa.DateTime(), nullable=False),
                    sa.Column('updated_at', sa.DateTime(), nullable=False),
                    sa.ForeignKeyConstraint(['destination_airport_id'], [
                        'airports.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['origin_airport_id'], [
                        'airports.id'], ondelete='RESTRICT'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('flights',
                    ...
                    sa.Column('scheduled_departure',
                              sa.DateTime(), nullable=True),
                    sa.Column('scheduled_arrival',
                              sa.DateTime(), nullable=True),
                    sa.Column('status', sa.Enum('scheduled', 'delayed', 'departed',
                                                'arrived', 'cancelled', name='flight_status'), nullable=False),
                    sa.Column('id', sa.Integer(),
                              autoincrement=True, nullable=False),
                    sa.Column('created_at', sa.DateTime(), nullable=False),
                    sa.Column('updated_at', sa.DateTime(), nullable=False),
                    sa.ForeignKeyConstraint(
                        ['airline_id'], ['airlines.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(
    ...
    op.create_table('tariffs',
                    ...
                    sa.Column('seat_class', sa.Enum(
                        'economy', 'business', name='seat_class'), nullable=False),
    ...
    op.create_table('tariff_discount',
                    ...
                    sa.ForeignKeyConstraint(
                        ['discount_id'], ['discounts.id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
    ...
    op.create_table('tickets',
                    ...
                    sa.ForeignKeyConstraint(
                        ['booking_id'], ['bookings.id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['discount_id'], ['discounts.id'], ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(
                        ['flight_id'], ['flights.id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['passenger_id'], ['passengers.id'], ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(
                        ['seat_id'], ['seats.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
