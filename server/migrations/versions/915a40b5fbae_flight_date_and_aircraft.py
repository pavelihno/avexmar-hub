...
def upgrade():
    ...
    with op.batch_alter_table('flights', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('scheduled_departure_time', sa.Time(), nullable=True))
        batch_op.add_column(sa.Column('scheduled_arrival_time', sa.Time(), nullable=True))
        ...
        batch_op.alter_column('scheduled_arrival',
               ...
               type_=sa.Date(),
               nullable=False)
        batch_op.create_unique_constraint('uix_flight_number_airline_route_departure', ['flight_number', 'airline_id', 'route_id', 'scheduled_departure'])
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('flights', schema=None) as batch_op:
        batch_op.drop_constraint('uix_flight_number_airline_route_departure', type_='unique')
        batch_op.alter_column('scheduled_arrival',
